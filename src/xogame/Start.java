...
public class Start extends AnchorPane {
    ...
    public Start(Stage stage) {
        ...
        singleuser.setTextFill(javafx.scene.paint.Color.valueOf("white"));
        singleuser.setFont(new Font("System Bold", 20.0));
        singleuser.setStyle("-fx-background-radius: 100; -fx-background-color: #b69121;");
        ...
        multiuser.setTextFill(javafx.scene.paint.Color.valueOf("white"));
        multiuser.setFont(new Font("System Bold", 20.0));
        multiuser.setStyle("-fx-background-radius: 100; -fx-background-color: #b69121;");
       ...
       // XO.setImage(new Image(getClass().getResource("/img/XOLOGO.jpg").toExternalForm()));
        ...
        multiuser1.setTextFill(javafx.scene.paint.Color.valueOf("white"));
        multiuser1.setFont(new Font("System Bold", 20.0));
        multiuser1.setStyle("-fx-background-radius: 100; -fx-background-color: #b69121;");
        ...
        replay.setTextFill(javafx.scene.paint.Color.valueOf("white"));
        replay.setFont(new Font("System Bold", 20.0));
        replay.setStyle("-fx-background-radius: 100; -fx-background-color: #b69121;");
