...
public abstract  class onlineBoardUiBase extends DialogPane {
    ...
    public onlineBoardUiBase() {
        ...
        P1.setText("Player1");
        P1.setTextFill(javafx.scene.paint.Color.valueOf("#7c541c"));
        P1.setFont(new Font("System Bold", 18.0));

        PX.setLayoutX(161.0);
        PX.setLayoutY(51.0);
        PX.setText("X");
        PX.setFont(new Font("System Bold", 20.0));

        scoreX.setLayoutX(219.0);
        scoreX.setLayoutY(42.0);
        scoreX.setText("0");
        scoreX.setTextFill(javafx.scene.paint.Color.valueOf("#7c541c"));
        scoreX.setFont(new Font(30.0));

        scoreO.setLayoutX(545.0);
        scoreO.setLayoutY(41.0);
        scoreO.setText("0");
        scoreO.setTextFill(javafx.scene.paint.Color.valueOf("#7c541c"));
        scoreO.setFont(new Font(30.0));

        PO.setLayoutX(489.0);
        PO.setLayoutY(51.0);
        PO.setText("O");
        PO.setFont(new Font("System Bold", 20.0));
        ...
        P2.setText("Player2");
        P2.setTextFill(javafx.scene.paint.Color.valueOf("#7c541c"));
        ...
        recordBtn.setLayoutX(475.0);
        recordBtn.setLayoutY(361.0);
        recordBtn.setMnemonicParsing(false);
        recordBtn.setOnAction(this::switchRecordOption);
        recordBtn.setPrefHeight(46.0);
        recordBtn.setPrefWidth(119.0);
        recordBtn.setStyle("-fx-background-color: #b69121 #b69121; -fx-background-radius: 100;");
        recordBtn.setText("Record");
        recordBtn.setTextFill(javafx.scene.paint.Color.valueOf("#fffaf2"));
        recordBtn.setFont(new Font("System Bold", 22.0));
    ...
    protected abstract void set0(javafx.event.ActionEvent actionEvent);
    protected abstract void switchRecordOption(javafx.event.ActionEvent actionEvent);

    protected abstract void playAgain(javafx.event.ActionEvent actionEvent);

    protected abstract void goToHome(javafx.event.ActionEvent actionEvent);
